...
def get_draft_selections(
    ...
    try:
        ...
        return DraftSelectionListResponse(data=selections)
...
def create_draft_selection(
    ...
    try:
        selection = add_draft_selection(
            db,
            student_id=student_id,
            course_id=payload.course_id,
        )
        return DraftSelectionResponse(data=selection)
...
def delete_draft_selection(
    ...
    try:
        removed = remove_draft_selection(
            db,
            student_id=student_id,
            course_id=course_id,
        )
        return DraftSelectionRemovedResponse(data=removed)
